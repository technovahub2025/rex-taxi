...
function TermsPage() {
  ...
  const styles = useMemo(() => ["\n\t\t .hl-hed{font-size:18px;line-height:22px;font-weight:500;}.mb30{margin-bottom:30px;}\n\t\t @media (max-width: 480px){\n\t\t\t .hl-hed{font-size:16px;line-height:20px;font-weight:500;}}\n\t\t "], []);
  ...
  usePageAssets({
    title: `Our Terms & Conditions - Red Taxi`,
    links,
    styles,
    scripts,
  });
